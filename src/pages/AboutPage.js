        ...
        <div className="first-div">
          ...
          <div className="title">
            ...
            <p>
              ...
              <p>
                With a user-friendly website and detailed product descriptions,
                it became renowned as a go-to destination for unique furniture.
              </p>
          </div>
        </div>
        <div className='second-div'>
          ...
          <p>
              ...
              <p>
                ...
                connecting through social media. Today, Rustic Root stands tall
                as a symbol of excellence in online furniture retail. From a
                dream to a revered brand, it leaves an indelible mark on the
                world of furniture. With unwavering dedication to preserving
                rustic elegance and French heritage, Rustic Root invites
                customers into a world where timeless beauty reigns.
              </p>
        </div>
      </Wrapper>
    </main>
